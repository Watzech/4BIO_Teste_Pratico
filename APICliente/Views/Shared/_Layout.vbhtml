...
<body>
    <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-dark bg-dark">
        <div class="container">
            @Html.ActionLink("ClienteAPI", "Index", "Cliente", New With {.area = ""}, New With {.class = "navbar-brand"})
    ...
    <div class="container body-content">
        ...
        <hr />
        <footer>
            <p>&copy; @DateTime.Now.Year - Henrique Watzech Milani</p>
        </footer>
    </div>
